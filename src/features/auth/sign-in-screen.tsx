      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="w-full max-w-xl space-y-2 px-4">
          <div className="text-center">
            ...
            />
            <h1 className="-mt-4 text-4xl font-medium tracking-tight text-zinc-50 sm:text-5xl">
              Welcome back
            </h1>
          ...
          <div className="mx-auto w-full max-w-[420px]">
            ...
            <form onSubmit={onSubmit}>
              ...
              <input
                ...
                className="mb-3 w-full rounded-xl border border-zinc-700 bg-zinc-900/50 px-3.5 py-2.5 text-sm text-zinc-100 outline-none transition-colors focus:border-zinc-500"
